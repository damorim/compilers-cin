...
from autogen.GrammarVisitor import GrammarVisitor
...
class GrammarCheckerVisitor(GrammarVisitor):
	id_values = {}
	...
	def visitAddSubExpr(self, ctx:GrammarParser.AddSubExprContext):
