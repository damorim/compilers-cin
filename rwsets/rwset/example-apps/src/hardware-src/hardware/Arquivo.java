...
public class Arquivo {
   ...
   /** Fecha o arquivo quando o garbage collector e chamado */
   ...
   /**
    * Le uma linha do arquivo. Se parte da linha ja foi lida, entao o restante
    * e retornado, mesmo que seja uma linha em branco (String de tamanho zero).
    *
    ...
    */
    ...
    /** Encontra a posicao do proximo token a ser lido */
    ...
    *
    * @param s     string que sera escrita no arquivo
    *
    */
   ...
   /**
    * Grava os dados do buffer no arquivo. Isto e feito automaticamente a cada
